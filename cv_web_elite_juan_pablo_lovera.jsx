...
export default function CVWebEliteJuanPablo() {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <main className="relative mx-auto max-w-7xl px-6 py-8 md:px-10 lg:px-12">
        <motion.section
          ...
          animate="visible"
          variants={fadeUp}
          className="rounded-[2rem] border border-white/10 bg-white/5 p-6 shadow-2xl backdrop-blur-xl md:p-10"
        >
          <div className="grid gap-10 lg:grid-cols-[1.3fr_0.7fr]">
            <div className="space-y-6">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <Badge className="rounded-full border border-white/10 bg-white/5 px-4 py-1 text-slate-200 hover:bg-white/5">
                  Humanizado · Premium · Estratégico
                </Badge>
              </div>
          ...
          {expertise.map((item, i) => {
            ...
            return (
              <motion.div
                ...
                variants={fadeUp}
              >
                <Card className="h-full rounded-[1.75rem] border-white/10 bg-white/5 shadow-xl backdrop-blur-xl">
        ...
        <motion.section
          ...
          animate="visible"
          variants={fadeUp}
          className="mt-8 rounded-[2rem] border border-white/10 bg-white/5 p-6 shadow-2xl backdrop-blur-xl md:p-8"
        >
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {group.items.map((item) => (
                      <Badge
                        key={item}
                        className="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-slate-200 hover:bg-white/5"
                      >
                        {item}
                      </Badge>
                    ))}
            ...
            {experience.map((job, i) => (
              ...
              >
                <div className="flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
                  ...
                  <Badge className="w-fit rounded-full border border-white/10 bg-white/5 px-3 py-1 text-slate-200 hover:bg-white/5">
                    {job.period}
                  </Badge>
                </div>
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          <motion.div initial="hidden" animate="visible" variants={fadeUp}>
            <Card className="h-full rounded-[2rem] border-white/10 bg-white/5 shadow-2xl backdrop-blur-xl">
          ...
          <motion.div initial="hidden" animate="visible" variants={fadeUp}>
            <Card className="h-full rounded-[2rem] border-white/10 bg-gradient-to-br from-cyan-500/10 via-white/5 to-violet-500/10 shadow-2xl backdrop-blur-xl">
              <CardContent className="p-6 md:p-8">
